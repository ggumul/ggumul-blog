...
export const metadata = createMetadata({
  title: '꼬물 소개',
  description: '꼬물이 어떤 프로젝트를 만들고, 어떤 방식으로 기록하고 있는지 소개하는 페이지예요.',
  path: '/about',
});
    ...
    <div className="space-y-12">
      ...
      <section>
        ...
        <div className="max-w-3xl space-y-4 text-subtext leading-7">
          <p>꼬물이라는 이름에는 크게 움직이기보다, 작더라도 계속 이어 가겠다는 뜻을 담고 있어요.</p>
          <p>완성된 결과만 보여주기보다, 만들면서 판단이 어떻게 달라지는지도 함께 남기고 싶어요.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="max-w-3xl space-y-4 text-subtext leading-7">
          <p>짧은 카드 게임도 있고, 선택에 따라 전개가 달라지는 서사형 게임도 있고, 하나의 작업에서 갈라져 나온 실험작도 있어요.</p>
          <p>겉모습은 달라도 안에서 보고 있는 질문은 비슷해요. 짧게 해도 손에 남는 플레이를 만들 수 있을지, 완성 전의 상태도 어디까지 기록으로 남길 수 있을지를 계속 보고 있어요.</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="max-w-3xl space-y-4 text-subtext leading-7">
          <p>꼬물은 큰 팀은 아니에요. 그래서 만들면서 생기는 문제와 판단을 더 바로 기록할 수 있어요.</p>
          <p>이곳에는 결과뿐 아니라, 만드는 중에 있었던 수정과 실패, 방향 변경도 함께 남기고 있어요. 빠르지는 않지만 계속 만들고 있어요.</p>
        </div>
      </section>
    </div>
  );
